...
Настроить веб-сервер NGINX для одновременной публикации нескольких статичных сайтов на одном сервере с использованием технологии виртуальных хостов. В ходе работы необходимо:
- развернуть сервер на хостинге;
- установить и настроить NGINX;
- создать несколько конфигураций виртуальных хостов в каталоге `/etc/nginx/sites-available/`;
- подключить сайты через символические ссылки в `/etc/nginx/sites-enabled/`;
- выпустить SSL-сертификаты и проверить работу сайтов по HTTPS.
